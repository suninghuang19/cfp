...
parser.add_argument('--env_name', default="RUN_Coarse-v0",
...
parser.add_argument('--alpha', type=float, default=1e-2, metavar='G',
...
parser.add_argument('--start_steps', type=int, default=6000, metavar='N',
...
parser.add_argument("--coarse2fine_penalty", type=float, default=-1,
                    help="coarse2fine penalty")
parser.add_argument("--coarse2fine_bias", type=float, default=0.01,
